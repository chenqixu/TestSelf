...
import com.cqx.common.utils.string.JsonUtilsV2;
import com.cqx.common.utils.string.StringUitlEx1;
...
public class RESTResponse implements java.io.Serializable {
    ...
    public String getMessage() {
        return StringUitlEx1.isEmpty(msgDesc) ? ("HTTP " + httpStatusCode) : msgDesc;
    }
    ...
    public static RESTResponse fromClientResponse(ClientResponse response) {
        ...
        if (!StringUitlEx1.isEmpty(jsonString)) {
