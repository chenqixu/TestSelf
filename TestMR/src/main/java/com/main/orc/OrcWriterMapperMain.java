...
import com.mr.orc.OrcWriterMapper;
 ...
 * @author chenqixu
 */
public class OrcWriterMapperMain {

    private static final Logger logger = LoggerFactory.getLogger(OrcWriterMapperMain.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        //如果需要打成jar运行，需要下面这句
        job.setJarByClass(OrcWriterMapperMain.class);
