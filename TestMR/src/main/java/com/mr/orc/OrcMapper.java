...
public class OrcMapper extends Mapper<LongWritable, Text, NullWritable, Text> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OrcMapper.class);
//    private TypeDescription schema = TypeDescription.fromString("struct<name:string,age:int>");
