...
public class Videoinformation {
    ...
    private String typeCode;//分类code
    private String videoPlot;//情节
    private String videoRegion;//地区
    private String directName;//导演
    private String actorName;//演员
    private String language;//语言
    private String maskDescription;//
    private String releaseDate;//发行年份
    private String ppvId;//
    private String hImg;//图片地址
    private String vImg;//海报地址
    private String catgId;//类型id
    private String isNew;//新片
    private String information;//影片介绍
    private String relationlist;//关系列表
    private String definition;//清晰度
    private String cpcode;//
    private String contentSource;//节目来源
    private String specialLssueId;//
    private String programCount;//
    private String programTotalCount;//全集数
    private String videoScore;//节目评分
    private String rcmLevel;//
    private String playCounts;//页面显示点播次数
    private String tag;//
