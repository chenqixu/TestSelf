package com.newland.bi.bigdata.ssh;
...
public class SshTest {
	...
	private Expect4j getExpect() {
		try {
			...
			channel.connect();
			System.out.println(String.format("Logging to %s@%s:%s successfully!", user,
					ip, port));
			return expect;
		} catch (Exception ex) {
	...
	public static void main(String[] args) {
		...
		int port = 22;
		String user ="hadoop";
		String password = "hadoopA1!";
		String cmd[] = {"pwd"};
		SshTest ssh = new SshTest(ip,port,user,password);
		boolean flag = ssh.executeCommands(cmd);
		System.out.println(flag);
		System.out.println("----------getResponse----------");
		System.out.println("getResponse:"+ssh.getResponse());
