...
public class DiscardBean {
	...
	public DiscardBean(ByteBuf byteBuf) {
		if( byteBuf != null ) {
			...
			this.dataBean = DataBean.deserializableFromString(new String(dataBean));
		}
	}
	
	public static DataBean buildDataBean(String threadName, int value, String date) {
	...
	public String toString() {
		return "packageType：" + packageType + "，dataBean：" + dataBean.serializableToString();
	}
